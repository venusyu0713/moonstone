(function (enyo, scope) {
	/**
	 * (@link moon.RichText) is a Moonstone-styled RichText control, derived from [enyo.RichText](@link enyo.RichText).
	 * Typically, a (@link moon.RichText) is placed inside a [moon.InputDecorator](@link moon.InputDecorator), which
