(function (enyo, scope) {
	...
	enyo.kind(
		...
		published: {
			/**
			 * When true, the picker will use a 12-hour clock. (When (@link iLib) is loaded, this value will be ignored and
			 ...
			 * of 24 (and 12). (When (@link iLib) is loaded, this value will be ignored and the current locale's
			...
			/**
			 * When true, hours will be zero-padded. (When (@link iLib) is loaded, this value will be ignored and the
